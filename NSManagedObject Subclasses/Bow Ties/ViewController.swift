...
class ViewController: UIViewController {
  ...
  override func viewDidLoad() {
    ...
    request.predicate = NSPredicate(format: "serachKey == %@", firstTitle!)
  ...
  @IBAction func segmentedControl(control: UISegmentedControl) {
    ...
    fetchRequest.predicate = NSPredicate(format: "serachKey == %@",title!)
    // 执行查询请求
    var error:NSError?
  ...
  @IBAction func rate(sender: AnyObject) {
    ...
    func updateRating(numericString:String) {
        currentBowtie!.rating = NSNumber(double: (numericString as NSString).doubleValue)
        var error: NSError?
    ...
    func insertSampleData(){
        let fetchRequest = NSFetchRequest(entityName: "Bowtie")
        fetchRequest.predicate = NSPredicate(format: "serachKey != nil")
        ...
        for dict : AnyObject in dataArray!{
            ...
            bowtie.serachKey = btDict["searchKey"] as! String
